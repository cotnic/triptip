        ...
        echo "<a class=\"list-group-item\">
                      <div class=\"row\">
                          ...
                          <div class=\"col-xs-2\">
							  ...
							  <button  data-toggle=\"modal\" data-target=\"#mapsModal\" onclick=\"initMap({$row['pl_nlatitude']}, {$row['pl_nlongitude']})\"class=\"btn btn-default\"><i class=\"fa fa-map\" aria-hidden=\"true\"></i></button>
                          </div>
                      </div>
                  </a>";
	}
